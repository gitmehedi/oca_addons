odoo.define('ks_dashboard_ninja_pro_list.ks_dashboard_graph_preview', function (require) {
    ...
    var KsGraphPreview = common.AbstractField.extend({
        ...
        start: function() {
            this.field_manager.fields.ks_dashboard_item_type.on('change',this.field_manager.fields.ks_graph_preview,this.preview_update);
//            this.field_manager.fields.ks_chart_data_count_type.on('change',this.field_manager.fields.ks_graph_preview,this.preview_update);
            this.field_manager.fields.ks_chart_data.on('change',this.field_manager.fields.ks_graph_preview,this.preview_update);
            this.field_manager.fields.ks_chart_item_color.on('change',this.field_manager.fields.ks_graph_preview,this.preview_update);

//            this.field_manager.fields.ks_chart_relation_groupby.on('change',this.field_manager.fields.ks_graph_preview,this.preview_update);
        ...
        render_value: function () {
            ...
            if (this.fields.ks_dashboard_item_type && this.fields.ks_dashboard_item_type !== 'ks_tile' && this.fields.ks_dashboard_item_type !== 'ks_list_view'){
        ...
        _getChartData: function(){
            ...
            new Model('ks_dashboard_ninja.item').call('ks_chart_load',[]).then(function (data) {
                var self = this;
                ...
                self.ksChartColors(this.fields.ks_chart_item_color, this.ksMyChart, this.chart_type, this.chart_family);
            }.bind(this));
        },
        ...
        _renderGraph: function () {
            ...
            if (chart) {
                ...
                this.view.dataset._model.call('ks_chart_load',[]
                ).then(function (data) {
                    this.chart.update()
                }.bind(this));
            }
